export default {
    settings: {
      ...
      creativeWorkbench: {
        title: 'AI Studio',
        description: 'Configure retention, record limits, and running-task limits for image and video tasks.',
        enabled: 'Enable AI Studio',
        enabledHint: 'When off, keep settings but do not expose the user-facing entry; accepted tasks should still finish and remain queryable.',
        imageEnabled: 'Enable image creation',
        imageEnabledHint: 'The first version reuses the existing batch image pipeline.',
        videoEnabled: 'Enable video creation',
        videoEnabledHint: 'Video studio support comes next; keep this off for the first rollout.',
        autoCleanup: 'Auto-clean task files',
        autoCleanupHint: 'When on, terminal tasks and files are cleaned by retention days and record limits.',
        retentionDays: 'Retention days',
        retentionDaysHint: 'Use 3 days during trial operation. Range: 1-30 days.',
        maxRecords: 'Task records per user',
        maxRecordsHint: 'When exceeded, the oldest terminal tasks are cleaned first.',
        imageRunning: 'Image running limit',
        imageRunningHint: 'New image tasks are rejected when the user reaches this limit.',
        videoRunning: 'Video running limit',
        videoRunningHint: 'New video tasks are rejected when the user reaches this limit.',
        storageHint: 'Generated media should not live on the app server long-term. Images keep using the existing object-storage settings; video should reuse the same temporary storage strategy when added.',
        saved: 'Studio settings saved',
        saveFailed: 'Failed to save studio settings',
      },
