export default {
    settings: {
      ...
      creativeWorkbench: {
        title: 'AI 创作台',
        description: '配置图片、视频任务的保留周期、记录上限和并发上限。',
        enabled: '启用 AI 创作台',
        enabledHint: '关闭后用户侧入口保留配置但不建议对外开放；已创建任务仍应继续完成和查询。',
        imageEnabled: '启用图片创作',
        imageEnabledHint: '第一版复用现有批量生图链路。',
        videoEnabled: '启用视频创作',
        videoEnabledHint: '视频工作台后续接入，第一版建议先关闭。',
        autoCleanup: '自动清理任务文件',
        autoCleanupHint: '开启后按保留天数和记录上限清理终态任务及文件。',
        retentionDays: '保留天数',
        retentionDaysHint: '建议试运营统一 3 天，范围 1-30 天。',
        maxRecords: '每用户任务记录上限',
        maxRecordsHint: '超过上限时优先清理最早的终态任务。',
        imageRunning: '图片进行中上限',
        imageRunningHint: '达到上限时拒绝创建新图片任务。',
        videoRunning: '视频进行中上限',
        videoRunningHint: '达到上限时拒绝创建新视频任务。',
        storageHint: '生成内容不应长期保存在本机。图片继续复用现有对象存储配置；视频接入时也会优先复用同一对象存储和临时保留策略。',
        saved: '创作台设置已保存',
        saveFailed: '保存创作台设置失败',
      },
