...
func defaultModelsListCandidateIDs(platform string) []string {
	...
	case PlatformMiniMax:
		return append([]string(nil), DefaultMiniMaxModelIDs...)
	case PlatformOpenAI:
...
func (s *adminServiceImpl) CreateGroup(ctx context.Context, input *CreateGroupInput) (*Group, error) {
	...
	allowBatchImageGeneration := input.AllowBatchImageGeneration && allowImageGeneration && batchImagePlatformSupportsProvider(platform)
...
func (s *adminServiceImpl) UpdateGroup(ctx context.Context, id int64, input *UpdateGroupInput) (*Group, error) {
	...
	if !group.AllowImageGeneration || !batchImagePlatformSupportsProvider(group.Platform) {
