...
func TestGatewayRoutesOpenAIMiniMaxVideoGenerationsAreRegistered(t *testing.T) {
...
func TestGatewayRoutesNonGrokVideoEditAndExtensionAreRejectedAtPlatformGate(t *testing.T) {
	router := newGatewayRoutesTestRouter(service.PlatformOpenAI)
